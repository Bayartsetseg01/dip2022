...
import { BiBot, BiUser, BiChat } from "react-icons/bi";
...
function Basic() {
  ...
  const rasaAPI = async function handleClick(name, msg, png) {
    ...
    await fetch("http://localhost:5005/webhooks/rest/webhook", {
      ...
      body: JSON.stringify({ sender: name, message: msg, image: png }),
    })
      ...
      .then((response) => {
        if (response) {
          ...
          const recipient_png = temp["image"];
          ...
          <div className="card" style={stylecard}>
            <div className="cardHeader text-white" style={styleHeader}>
              <h1 style={{ marginBottom: "0px" }}>
                {" "}
                <BiBot className="bot" />
                {/* <img src="../img/t.jpeg" alt="" width="50" height="33"></img> */}
              </h1>
